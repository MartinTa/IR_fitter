...
class Application():
    ...
    def createWidgets(self):
        ...
        self.browseButton.bind("<Enter>",lambda event: self.status.set("browse for spectrum files (.DX, .csv or .DPT) and add them to list"))
    ...
    def BrowseClick(self):
        filepaths = filedialog.askopenfilenames(filetypes=[('spectrum file',('*.DPT','*.csv','*.DX'))])
